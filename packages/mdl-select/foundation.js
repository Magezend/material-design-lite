...
export default class MDLSelectFoundation extends MDLFoundation {
  ...
  static get defaultAdapter() {
    return {
      ...
      openMenuWithFocusedOptionAtIndex: (/* index: number */) => {},
  ...
  setDisabled(disabled) {
    ...
    if (this.disabled_) {
      ...
      this.adapter_.makeUnfocusable();
    } else {
      this.adapter_.removeClass(DISABLED);
      this.adapter_.rmAttr('aria-disabled');
      this.adapter_.makeFocusable();
    }
  }
  ...
  open_() {
    ...
    const indexToFocus = this.selectedIndex_ < 0 ? 0 : this.selectedIndex_;
    this.adapter_.addClass(OPEN);
    this.adapter_.openMenuWithFocusedOptionAtIndex(indexToFocus);
  }
